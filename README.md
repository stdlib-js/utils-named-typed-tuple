...
```javascript
import namedtypedtuple from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-named-typed-tuple@v0.2.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/utils-named-typed-tuple/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/utils-named-typed-tuple/actions/workflows/test.yml?query=branch:v0.2.1
